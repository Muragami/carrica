...
* 0.2.0 Michiru - Buffer Wren class for a shared binary memory buffer.
* 0.3.0 Uruka - fully functional threading and thread safety.
* 0.4.0 Iora - fully implemented support for loading Wren binary modules.
* 0.5.0 Ashella - exposed system for lua to "get" Wren classes/class objects.
* 0.6.0 Nasa - ???
